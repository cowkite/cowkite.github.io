...
* 테이블 결과 확인
  ...
  ![](D:\soyeon.kim\2. 개인\images\01.PNG)
...
* 그래프 그리기
  ...
  * **가정**: RM(방의 갯수)와 MEDV(집값) 사이에 선형 관계가 있다.
    ...
    * **𝐽(𝜃)J(θ)의 그래프**
      ...
      * 𝜃θ에 따라 변하는 𝐽(𝜃)J(θ)의 그래프를 그려보면 다음과 같다.
        ...
        ![](D:\soyeon.kim\2. 개인\images\02.PNG)
    ...
    * **극소점(Local Minimum)에 빠질 위험**
      ...
      * 경사 하강법은 최솟값을 찾는 절대적인 알고리즘은 아니다. 최솟값이 아닌 극소점 (local minimum), 즉 주변보다는 낮지만 가장 낮은 값은 아닌 지점에 빠질 위험이 있다.![](D:\soyeon.kim\2. 개인\images\03.PNG)
    ...
    * **선형 회귀를 위한 경사 하강법 (Gradient descent for linear regression)**
      ...
      ![](D:\soyeon.kim\2. 개인\images\04.PNG)
    ...
    * 다회 시도하여 수렴하는지 테스트
      ...
      ![](D:\soyeon.kim\2. 개인\images\05.PNG)
      ...
      ![](D:\soyeon.kim\2. 개인\images\06.PNG)
  ...
  * 결국은 Preprocessing을 하기 위한 과정임
    ...
    * 데이터 확인
      ...
      ![](D:\soyeon.kim\2. 개인\images\07.PNG)
  ...
  * Preprocessing 과정
    ...
    * 데이터 관측
      ...
      ![](D:\soyeon.kim\2. 개인\images\08.PNG)
    ...
    * Training 데이터의 GrLivArea 중 오른쪽 하단에 이상치(outlier) 2개 삭제
      ...
      ![](D:\soyeon.kim\2. 개인\images\09.PNG)
    ...
    * **Missing Data**
      ...
      1. **Missing ratio 확인**
         ...
         ![](D:\soyeon.kim\2. 개인\images\10.PNG)
      ...
      2. **Data Correlation**
         ...
         ![](D:\soyeon.kim\2. 개인\images\11.PNG)
